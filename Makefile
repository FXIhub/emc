...
emc.o: emc.c
	gcc $(DEBUG) -std=c99 -c emc.c `gsl-config --cflags` -I/usr/local/cuda/include
...
#	nvcc --compiler-bindir=/usr/bin/gcc-4.4 -m64 -c emc_cuda.cu -I/usr/local/cuda/include -I${HOME}/git/libspimage/include/thrust-1.3.0 -g 
	nvcc $(DEBUG_CUDA) -c emc_cuda.cu -I/usr/local/cuda/include -I${HOME}/git/libspimage/include/thrust-1.3.0 -arch sm_20

emc_atomic.o: emc_atomic.cu
#	nvcc --compiler-bindir=/usr/bin/gcc-4.4 -m64 -I/usr/local/cuda/include -c emc_atomic.cu -arch sm_12
	nvcc $(DEBUG_CUDA) -I/usr/local/cuda/include -c emc_atomic.cu -arch sm_20
