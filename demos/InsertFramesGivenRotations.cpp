...
int main(int argc, char *argv[]){
    ...
    read_best_rot(conf.rotations_file, &rotations, &weights_rotation, N_slices, N_images, respons);
    //for (int i =1; i<100; i++)
     //   cout << rotations[i].q[0] << " " <<rotations[i].q[3] <<" " <<weights_rotation[i] <<" " <<respons[i] <<endl;
